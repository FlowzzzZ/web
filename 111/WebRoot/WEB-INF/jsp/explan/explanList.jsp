...
<script type="text/javascript" src="<%=basePath %>/js/explan/explans.js"></script>
...
<div class="contains">
	<div class="header">
		<div class="header_left">
			<span class="search_tips">客户单号</span>
			<input class="common_input" type="text" name="customernumber" id="customernumber"/>
