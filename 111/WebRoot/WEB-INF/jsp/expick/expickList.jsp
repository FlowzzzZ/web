...
<script type="text/javascript" src="<%=basePath %>/js/expick/expickList.js"></script>
...
<div class="contains">
	<div class="header">
		<div class="header_left">
			<span class="search_tips">商品代码</span>
			<input class="common_input" type="text" name="goodsNumber" id="goodsNumber"/>
			<span class="search_tips">商品名称</span>
			<input class="common_input" type="text" name="goodsname" id="goodsname"/>
			<span class="search_tips">批号</span>
			<input class="common_input" type="text" name="goodsname" id="goodsname"/>
			<span class="search_tips">规格</span>
			<input class="common_input" type="text" name="goodsname" id="goodsname"/>
			<!-- <span class="search_tips">时间段</span>
			<input class="common_input" type="text" name="startTime" id="startTime"/>：
			<input class="common_input" type="text" name="endTime" id="endTime"/> -->
			<input class="common_btn" type="button" value="查询" id="stockSearch"/>
		</div>
	...
	<div class="table_name">选货商品列表</div>
	<div class="table">
